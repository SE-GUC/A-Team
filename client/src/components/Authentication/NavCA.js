...
export class Navca extends Component {
  state={
    id:'',
    name:'',
    username:'',
...
<ul id="dropdown11" class="dropdown-content">
  ...
  <li><a href='/ca/get_tasks'>Get Tasks</a></li> 
  <li><a href='/ca/ViewTaskApplicants'>View applicants</a></li> 
  <li><a href='/ca/task_card'>Task Cards</a></li> 
  {/* <li><a class='ili' href='/StoryOnePointEleven'>Tasks i applied on</a></li> //member */}
</ul>
<ul id="dropdown111" class="dropdown-content">
  <li><a href='/ca/Create_Events'>Create Events</a></li>
  <li><a href="/ca/feedback">Write Feedback </a></li>
  <li><a href="/ca/appcard">Apply for Event </a></li>
  <li><a href='/ca/partnerfeedbacks'>Feedbacks on my Events</a></li>
</ul>
<ul id="dropdown11111" class="dropdown-content">
  <li><a class='ili' href='/ca/viewallproj'>All Projects</a></li>
  <li><a class='ili' href='/ca/post_project'>Post a Project</a></li>
</ul>
