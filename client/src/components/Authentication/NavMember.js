...
export class NavMember extends Component {
  state={
    id:'',
    name:'',
    username:'',
...
<ul id="dropdown11" class="dropdown-content">
  {/* <li><a href='/member/submit_task'>Post a Task</a></li> */}
  <li><a href='/member/recommend'>Recommend Tasks</a></li>
  <li><a href='/member/get_tasks'>Get Tasks</a></li> 
  {/* <li><a href='/partner/ViewTaskApplicants'>View applicants</a></li>  */}
  <li><a href='/member/task_card'>Task Cards</a></li> 
  <li><a class='ili' href='/member/StoryOnePointEleven'>Tasks i applied on</a></li>
</ul>
<ul id="dropdown111" class="dropdown-content">
  {/* <li><a href='/member/Create_Events'>Create Events</a></li> */}
  <li><a href="/member/feedback">Write Feedback </a></li>
  <li><a href='/member/filter'>Show Events</a></li>

  <li><a href="/member/appcard">Apply for Event </a></li>
  <li><a href='/member/partnerfeedbacks'>Feedbacks on my Events</a></li>
</ul>
<ul id="dropdown11111" class="dropdown-content">
  <li><a class='ili' href='/member/viewallproj'>All Projects</a></li>
